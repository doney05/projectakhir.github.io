...
<script src="https://cdnjs.cloudflare.com/ajax/libs/izitoast/1.4.0/js/iziToast.js"
    ...
    $('#tombol-tambah').click(function () {
        ...
        $('#modal-judul').html("Detail Transaksi"); //valuenya tambah pegawai baru
    ...
    $(document).ready(function () {
            $('.yajra-datatable').DataTable({
                ...
                {data: 'travel->title', name: 'travel->title'},
    ...
    //SIMPAN & UPDATE DATA DAN VALIDASI
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('transaction.show') }}", //url simpan data
        ...
        $('body').on('click', '.edit-post', function () {
            ...
            $.get('transaction/' + data_id + '/edit', function (data) {
        ...
        $('#tombol-hapus').click(function () {
            $.ajax({
                ...
                url: "transaction/" + dataId, //eksekusi ajax ke url ini
                type: 'delete',
                beforeSend: function () {
